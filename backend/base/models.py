...
def upload_image_path(instance, filename):
    ...
    return "base/static/base/images//{new_filename}/{final_filename}".format(
...
class Supply(models.Model):
    ...
    LITRO = 'LT'
    METRO = 'MT'
    TIPO_CHOICES = ((KILO, 'Kilo'), (UNIDAD, 'Unidad'),
...
class SystemParameters(models.Model):
    precio_hora_trabajada = models.DecimalField(
...
class Purchase(models.Model):
    ...
    fecha = models.DateField('Fecha de la operación',
